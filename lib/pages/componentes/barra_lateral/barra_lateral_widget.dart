...
import 'barra_lateral_model.dart';
export 'barra_lateral_model.dart';
      ...
      child: Align(
        ...
        child: FutureBuilder<List<UsersRow>>(
          ...
          builder: (context, snapshot) {
            ...
            List<UsersRow> sideNav08UsersRowList = snapshot.data!;

            final sideNav08UsersRow = sideNav08UsersRowList.isNotEmpty
                ? sideNav08UsersRowList.first
                : null;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (sideNav08UsersRow.rol == 'Admin')
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            16.0, 0.0, 16.0, 12.0),
                        child: InkWell(
