                          ...
                          Padding(
                            ...
                            child: FutureBuilder<List<HorarioRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<HorarioRow> listViewHorarioRowList =
                                    snapshot.data!;
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount: listViewHorarioRowList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewHorarioRow =
                                        listViewHorarioRowList[listViewIndex];
                                    return FutureBuilder<List<AulasRow>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<AulasRow> listTileAulasRowList =
                                            snapshot.data!;

                                        final listTileAulasRow =
                                            listTileAulasRowList.isNotEmpty
                                                ? listTileAulasRowList.first
                                                : null;
                          ...
                          Padding(
                            ...
                            child: FutureBuilder<List<GuardiasRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<GuardiasRow> listViewGuardiasRowList =
                                    snapshot.data!;
                                ...
                                return ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: listViewGuardiasRowList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewGuardiasRow =
                                        listViewGuardiasRowList[listViewIndex];
                                    return FutureBuilder<List<AulasRow>>(
                                      future: AulasTable().querySingleRow(
                                        queryFn: (q) => q.eqOrNull(
                                          'id',
                                                    ...
                                                    data: {
                                                      ...
                                                      'hora':
                                                          listViewGuardiasRow
                                                              .hora,
                                                      'activa': false,
                                                      'dia': listViewGuardiasRow
                                                          .dia,
                                                    },
                                                    matchingRows: (rows) =>
                                                        rows.eqOrNull(
                                                      'id',
                                                      listViewGuardiasRow.id,
                                                    ),
                                                  );
                                                  safeSetState(() => _model
