...
import '/pages/componentes/elegir_tramo_guardia/elegir_tramo_guardia_widget.dart';
...
import 'guardias_model.dart';
export 'guardias_model.dart';

class GuardiasWidget extends StatefulWidget {
  const GuardiasWidget({
    super.key,
  ...
  static String routeName = 'Guardias';
  static String routePath = '/guardias';

  @override
  State<GuardiasWidget> createState() => _GuardiasWidgetState();
}

class _GuardiasWidgetState extends State<GuardiasWidget>
    with TickerProviderStateMixin {
  late GuardiasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuardiasModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<GuardiasRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<GuardiasRow> guardiasGuardiasRowList = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                Visibility(
                  visible: widget.tipoUsuario == 'Admin',
                  child: Builder(
                            ...
                            builder: (dialogContext) {
                              return Dialog(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: ElegirTramoGuardiaWidget(
                                    modo: 'Insertar',
                                  ),
                                ),
                              );
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: FutureBuilder<
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    final textAulasRow = textAulasRowList
                                                                            .isNotEmpty
                                                                        ? textAulasRowList
                                                                            .first
                                                                        : null;
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Text(
                                                                                valueOrDefault<String>(
                                                                                  functions.quitarString(valueOrDefault<String>(
                                                                                    horItem.hora,
                                                                                    '8:30',
                                                                                  )),
                                                                                  '8:30',
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                    FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'dq4hdhck' /* Posibles asignaciones: */,
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
