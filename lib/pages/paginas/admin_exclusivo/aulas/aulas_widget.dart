              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'rh72m42p' /* Lista de aulas del centro */,
                              ),
                    ...
                    Builder(
                      builder: (context) {
                        final aul = aulasAulasRowList.toList();

                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: aul.length,
                          itemBuilder: (context, aulIndex) {
                            final aulItem = aul[aulIndex];
                            return Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 10.0, 0.0, 0.0),
                              child: Material(
